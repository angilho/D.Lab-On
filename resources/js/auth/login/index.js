...
const Login = ({}) => {
	...
	useEffect(() => {
		...
		if (location.state && location.state.findUserLogin) setFindUserLogin(location.state.findUserLogin);
	}, [location]);
	...
	const login = e => {
		...
		ctrl.login(userLogin, userPassword, remember, callbackLoginFailed);
	};
			...
			<Row className="justify-content-center">
				<Col align="center">
					...
					>
						...
						<Row className="mt-10">
							<Col>
								<Text p3 underline cursor link="/user/find">
									아이디/비밀번호 찾기
								</Text>
							</Col>
							<Col>
								<Text p3 underline cursor link="/register" className="justify-content-end">
									회원가입
								</Text>
							</Col>
						</Row>
