...
class CourseStoreRequest extends FormRequest
{
	...
	public function messages()
	{
		return [
			...
			"thumbnail.required" => "썸네일 이미지가 없습니다.",
